...
- Exemple 1 : Vous avez déployé Le Backup Agent sur 3 serveurs Bare Metal et ceux-ci envoient leurs données vers leurs Vaults respectifs. La totalité des capacités utilisées par vos données de sauvegarde sur les Vaults est de 600GB. Vous serez donc facturé à la fin du mois pour 600GB.

- Exemple 2 : Vous avez déployé Le Backup Agent sur 10 serveurs Bare Metal et ceux-ci envoient leurs données vers leurs Vaults respectifs. La totalité des capacités utilisées par vos données de sauvegarde sur les Vaults est de 600GB. Après quelques sauvegardes, vous retirez Le Backup Agent de 4 serveurs, supprimant les données après 14 jours. L'utilisation totale des Vaults tombe à 400GB. Vous serez facturé à la fin du mois pour 600GB.
