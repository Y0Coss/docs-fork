...
#### Q: What if a source bucket with offsite replication enabled is deleted? and what about the initial replication rule?
...
#### Q: How can I access my backed up data and which actions are possible with the replica bucket?
