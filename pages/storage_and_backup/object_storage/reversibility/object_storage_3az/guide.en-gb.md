...
| --- | --- | --- | --- | --- |
| Management via OVHcloud Manager/OVH API | OVHcloud proprietary GUI and API for storage management | N/A | **Incoming** : Not applicable.  **Output** : Scripts/API to be rewritten for the target environment. | [Manage-buckets](/pages/storage_and_backup/object_storage/s3_bucket_acl) |
