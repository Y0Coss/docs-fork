...
|---|---|---|---|---|
| **Compatibilité  API S3 standard**| Accès et gestion via API compatible S3 (RESTful, outils CLI AWS, SDK, etc.).| S3 (REST, JSON, objets)|**Entrant** : Upload direct dans un bucket Object Storage via l’API S3, CLI ou SDK. <br> **Sortant** : Récupération/export direct via API S3, CLI ou SDK vers tout autre fournisseur compatible S3. | [Présentation de l'offre commerciale Cold Archive](https://www.ovhcloud.com/fr/public-cloud/cold-archive/) <br> [Documentation offre Cold Archive](https://help.ovhcloud.com/csm/en-gb-documentation-storage-object-storage?id=kb_browse_cat&kb_id=38e74da5a884a950f07829d7d5c75217&kb_category=b29021c8e5a5edd0f078850a25104df8&spa=1)|
| **Import/Export massif d'objects**    | Migration de données par lots à l'aide de commandes S3 (`aws s3 cp/sync`, etc.).| S3 (objets, dossiers)| **Entrant** : Copie des données depuis une autre solution S3 vers le bucket Object Storage d’OVHcloud. <br> **Sortant** : Export massif via les mêmes outils vers une autre plateforme S3 ou compatible. | [Documentation offre Cold Archive](https://help.ovhcloud.com/csm/en-gb-documentation-storage-object-storage?id=kb_browse_cat&kb_id=38e74da5a884a950f07829d7d5c75217&kb_category=b29021c8e5a5edd0f078850a25104df8&spa=1) |
