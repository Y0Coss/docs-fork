...
You can either follow the CLI way or create AWS configuration files manually.
...
>> ```
>> Then, follow the steps and enter your AWS credentials generated by commands above
>>
> Manual method
>>
>> ```bash
