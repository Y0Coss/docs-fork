...
O NAS-HA suporta a transferência de ficheiros através do NFS (NFSv3, NFSv4.1, NFNSv4.2) e do CIFS (SMB).
...
As snapshots são armazenadas ao mesmo nível que o seu serviço.
Como complemento, a OVHcloud efetua um snapshot diário (com uma retenção de 24H) num servidor de backup situado num rack distinto.
...
Se precisar de formação ou de assistência técnica para implementar as nossas soluções, contacte o seu representante comercial ou clique em [esta ligação](/links/) para obter um orçamento e solicitar uma análise personalizada do seu projecto aos nossos especialistas da equipa de Serviços Profissionais.
