...
This problem can be solved by changing the Windows Registry. Open the Windows utility *regedit* and search for the entry `HKLM\SYSTEM\CurrentControlSet\Services\LanmanWorkstation\Parameters`.
