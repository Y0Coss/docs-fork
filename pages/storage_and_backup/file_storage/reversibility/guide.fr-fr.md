...
- Les [fonctionnalités principales](#core-features) pour lesquelles nous garantissons la possibilité de migrer6.
...
| **Accès multi-serveurs**          | Montage simultané sur plusieurs serveurs (Linux/Unix/VMs).                                                   | NFSv3                  | **Entrant** : Montage sur tous les serveurs OVHcloud concernés.<br>**Sortant** : Démontage, puis remontez sur la cible si compatible NFSv3. | [File Storage](/products/storage-file-storage)
