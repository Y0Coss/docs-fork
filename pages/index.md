...
+ Network
    ...
    + [Additional IP](network-additional-ip)
        ...
        + [Use cases](network-additional-ip-products)
            + [Dedicated Servers](network-additional-ip-dedicated-servers)
                ...
                + [Moving an Additional IP](bare_metal_cloud/dedicated_servers/ip-fo-move)
            ...
            + [Virtual Private Servers](network-additional-ip-vps)
                + [VPS - Configuring IP aliasing](virtual_private_servers/network/ipaliasing)
    ...
    + [vRack Private Network](products/network-vrack)
        + [Dedicated Servers](network-vrack-dedicated-servers)
            + [Configuring the network on Proxmox VE on the High Grade, Scale & Advance ranges](bare_metal_cloud/dedicated_servers/proxmox-network-hg-scale)
        ...
        + [Hosted Private Cloud](network-vrack-hosted-private-cloud)
            + [Nutanix on OVHcloud](network-vrack-hosted-private-cloud-nutanix)
            ...
            + [VMware on OVHcloud](network-vrack-hosted-private-cloud-vmware)
        ...
        + [Load Balancer](network-vrack-load-balancer)
            + [Configuring the vRack on the load balancer](network/load_balancer/vrack_and_loadbalancer)
        + [Managed Bare Metal](network-vrack-managed-bare-metal)
            + [VLAN creation](managed_bare_metal/vlan-creation)
            + [Using Managed Bare Metal within a vRack](managed_bare_metal/using-vrack)
        + [Public Cloud](network-vrack-public-cloud)
            + [Containers & Orchestration](network-vrack-public-cloud-containers-orchestration)
            ...
            + [Network Services](network-vrack-public-cloud-network-services)
