...
+ Hosted Private Cloud
    ...
    + [SNC Cloud Plateform](hosted-private-cloud-snc-cloud-plateform)
        + [Getting started](hosted-private-cloud-snc-cloud-plateform-getting-started)
            + [Mise en route de votre SNC Cloud Plateform](hosted_private_cloud/cloud_plateform/getting-started)
            + [Sauvegarder une instance](hosted_private_cloud/cloud_plateform/save-an-instance)
