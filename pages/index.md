    ...
    + [Public Cloud - General Information](products/public-cloud-cross-functional)
        ...
        + [Services management](public-cloud-cross-functional-services-management)
            ...
            + [Managing from OpenStack](public-cloud-cross-functional-openstack)
                ...
                + [Changing an OpenStack user password in Horizon](public_cloud/public_cloud_cross_functional/change_openstack_user_password_in_horizon)
                ...
                + [Authenticate on Openstack API with service account](manage_and_operate/iam/authenticate-api-openstack-with-service-account)
                + [Creating and deleting OpenStack users](public_cloud/public_cloud_cross_functional/create_and_delete_a_user)
