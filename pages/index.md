...
+ Account and service management
    ...
    + [Reversibility](products/account-and-service-management-reversibility)
        + [Reversibility policies](account-and-service-management-reversibility-reversibility-policies)
            ...
            + [Managed Message Broker Product Reversibility Policy](/pages/account_and_service_management/reversibility/14-mdb-reversbility)
            + [Managed Data Visualization Product Reversibility Policy](/pages/account_and_service_management/reversibility/15-obs-data-visulation-reversbility)
...
+ Public Cloud
    ...
    + [Public Cloud Databases](products/public-cloud-databases)
        ...
        + [General guides](public-cloud-databases-general-guides)
            ...
            + [Managed Message Broker Product Reversibility Policy](/pages/account_and_service_management/reversibility/14-mdb-reversbility)
            + [Managed Data Visualization Product Reversibility Policy](/pages/account_and_service_management/reversibility/15-obs-data-visulation-reversbility)
![image](https://github.com/user-attachments/assets/cbd08124-8c48-4b06-b905-f02fcc206727)
