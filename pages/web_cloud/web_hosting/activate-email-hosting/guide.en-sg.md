...
- A [domain name](/links/web/domains) registered with OVHcloud or a [DNS zone](https://www.ovhcloud.com/en-sg/domains/dns-subdomain/) of a domain name not registered with OVHcloud.
