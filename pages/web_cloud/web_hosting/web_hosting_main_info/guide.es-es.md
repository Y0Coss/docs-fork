...
Para más información sobre las fechas de fin de vida y soporte de PHP, así como sobre los entornos de ejecución, consulte nuestras guías:

- "[Anuncios de fin de vida/soporte de las versiones de PHP](/pages/web_cloud/web_hosting/php_eol_eos)".
