...
Para mais informações sobre as datas de fim de vida e suporte do PHP, ou ainda sobre os ambientes de execução, consulte os nossos manuais:

- "[Anúncios de fim de vida/suporte das versões de PHP](/pages/web_cloud/web_hosting/php_eol_eos)".
