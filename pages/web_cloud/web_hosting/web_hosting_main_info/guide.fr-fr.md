...
- <span style="color:green; background-color:#e0f7e9; padding:4px; border-radius:4px;">Active support</span> : Support complet assuré.
- <span style="color:orange; background-color:#fff3cd; padding:4px; border-radius:4px;">Security fixes only</span> : Corrections de sécurité uniquement.
- <span style="color:red; background-color:#f8d7da; padding:4px; border-radius:4px;">End of life</span> : Version obsolète, non maintenue.
