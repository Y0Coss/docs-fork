...
Clicca sulla scheda `Multisito`{.action} del tuo hosting, clicca su `...`{.action} a destra del nome di dominio o sottodominio interessato e quindi su `Modifica la CDN`{.action}. 
