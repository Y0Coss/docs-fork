...
> **Schritt 5**
>>
>> Geben Sie im angezeigten Fenster das neue Passwort Ihrer Datenbank ein (festgelegt in [Teil 3](#step3)), bestätigen Sie dieses und klicken Sie dann auf den Button `Bestätigen`{.action}.
>>
