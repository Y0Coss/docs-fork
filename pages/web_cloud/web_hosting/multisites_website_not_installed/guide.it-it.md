...
>> |La zona DNS attiva non contiene record di tipo A o AAAA che collegano il dominio o il sottodominio all'indirizzo IP dell'hosting Web.|Aggiungere il nuovo record DNS di tipo A o AAAA o correggere il record esistente seguendo [questa guida](/pages/web_cloud/domains/dns_server_edit).|
>> |Il record DNS di tipo A o AAAA esistente nella zona DNS per il dominio o il sottodominio punta verso un indirizzo IP diverso da quello dell’hosting Web.|Aggiungere il nuovo record DNS di tipo A o AAAA o correggere il record esistente seguendo [questa guida](/pages/web_cloud/domains/dns_server_edit).|
