...
Se inserisci l’indirizzo di un repository GitHub privato (di tipo `git@github.com:<username>/<repository_name>.git`), sotto il campo `Branch` viene visualizzato un campo `SSH key` (chiave SSH).
