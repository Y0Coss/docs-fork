...
>> 3: Véifiez lerésumé de la modification demandée, puis cliquez sur `Valider`{.action}.
>>
...
Après l'envoi de la commande, vous serez invité à renseigner le mot de passe de l’utilisateur SSH. Une fois connecté, poursuivez vers l'étape suivante « [Interagir en SSH avec son espace de stockage](#ssh-using) ».
