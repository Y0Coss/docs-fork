...
> **Step 4**
>>
>> On the page that pops up, click `Order Anycast DNS`{.action}.
>>
...
>>
>> - Choose the duration proposed in the `1` section and click `Next`{.action}.
>> - Select your payment method, then click `Pay`{.action} to continue activating Anycast DNS.
>>
