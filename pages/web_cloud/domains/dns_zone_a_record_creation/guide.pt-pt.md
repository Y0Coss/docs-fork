---
title: "Adicionar um registo DNS de tipo A para um domínio"
excerpt: "Saiba como adicionar um registo DNS de tipo A numa zona DNS gerida na OVHcloud para o seu domínio"
updated: 2025-05-12
---
...
**Saiba como adicionar um registo DNS de tipo A numa zona DNS gerida na OVHcloud para o seu domínio.**
...
### Adicionar um registo DNS de tipo A para um domínio
...
3. Na janela que se abrir, selecione o campo de apontamento do tipo `A`{.action}.
...
### Adicionar um registo DNS de tipo A para o subdomínio de um domínio
