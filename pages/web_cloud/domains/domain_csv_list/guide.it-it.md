...
> **Passaggio 2**
>>
>> Clicca sul menu `Domini`{.action}. Clicca sul pulsante `Esporta in CSV`{.action}.
>>
...
>>
>> Clicca sul pulsante `Esporta`{.action} per avviare la generazione del file in formato CSV.
>>
> **Passaggio 4**
>>
