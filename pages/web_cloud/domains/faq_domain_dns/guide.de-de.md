...
excerpt: "Hier finden Sie die wichtigsten Fragen zu Domainnamen, DNS-Servern und DNS-Zonen."
updated: 2025-10-06
---
...
1. Gehen Sie auf unsere Website [OVHcloud](/links/website).
...
5. Wählen Sie gegebenenfalls Optionen oder Dienste aus, zu denen Sie sich zusätzlich zu Ihrem Domainnamen anmelden möchten, und klicken Sie auf `Weiter`{.action}, bis Sie in den Bestellprozess eingeloggt werden oder ein OVHcloud-Kundenkonto erstellen.
6. Sobald Sie sich mit Ihrem OVHcloud-Kundenkonto angemeldet haben, können Sie die Kontaktinformationen (Eigentümer/Inhaber, Administrator, Technik) für Ihren Domainnamen anpassen. Klicken Sie anschließend auf die Schaltfläche `Weiter`{.action}, um zum Bestellzusammenfassung zu gelangen.
...
Zahlen Sie anschließend Ihre Bestellung, um die Reservierung Ihres Domainnamens sowie die Installation der Dienste und Optionen zu starten, zu denen Sie sich angemeldet haben.

Einige Minuten später erhalten Sie eine Bestätigungs-E-Mail für Ihre Bestellung.
Sie können anschließend Ihren Domainnamen verwalten, indem Sie sich in Ihr [OVHcloud Kundencenter](/links/manager) einloggen.

Zögern Sie nicht, ein Support-Ticket über das [Hilfezentrum](https://help.ovhcloud.com/csm?id=csm_get_help) zu erstellen, falls erforderlich.
...
Die schnellste Lösung besteht darin, eine [WHOIS](/links/web/domains-whois)-Abfrage für den Domainnamen durchzuführen. Nach Abschluss der Abfrage suchen Sie im Ergebnis die Zeile, die das Ablaufdatum angibt (z. B. `Expiry Date: 2025-09-22T08:00:00Z`, `Registry Expiry Date: 2025-09-22T08:00:00Z`, usw.).
...
Sobald ein Domainname bestellt wurde, wird er anhand der von Ihnen bei der Bestellung definierten Zeichen registriert. Die Registrierung erfolgt beim Register der Erweiterung Ihres Domainnamens (z. B. das Register für *.com*) und es gelten Gebühren für die Reservierung auf der Seite des Registrars (z. B. OVHcloud).

Ein Domainname ist eine eindeutige Adresse im Internet, z. B. `ovhcloud.com`.  
Jede Änderung in diesem Namen, sei es ein einzelnes Zeichen oder eine Erweiterung (.com, .fr, .net usw.), macht ihn zu einem völlig anderen Domainnamen.
...
> [!primary]
>
> Nachdem Sie die Kündigung angefordert haben, können Sie die Löschung beschleunigen, indem Sie ein Support-Ticket über das [Hilfezentrum](https://help.ovhcloud.com/csm?id=csm_get_help) erstellen. Dafür müssen Sie entsprechende Nachweise bereitstellen. 

> [!success]
>
> Alle Details finden Sie in unserem Leitfaden "[Kündigen von OVHcloud Diensten](/pages/account_and_service_management/managing_billing_payments_and_services/how_to_cancel_services)".
...
Zunächst, wenn Sie Zweifel an der Legitimität der erhaltenen E-Mail haben, konsultieren Sie unseren Leitfaden "[Betrug erkennen − So schützen Sie sich vor Phishing und betrügerischen E-Mails](/pages/account_and_service_management/account_information/phishing_care)".
...
- **Tage 4, 9 und 13 (Erinnerungse-Mails)**: Wenn Sie den Domainnamen noch nicht verifiziert haben, erhalten Sie die E-Mail erneut.
...
> [!warning]
>
> Abhängig von der Erweiterung des Domainnamens (z. B. *.com*, *.net*, usw.) können einige der oben genannten Fristen variieren. Wir empfehlen Ihnen dringend, sich beim Register der Erweiterung Ihres Domainnamens über den Verifikationsprozess der Kontaktdaten zu informieren.
...
Wenn Sie die Validierungs-E-Mail für den Inhaber Ihres Domainnamens nicht erhalten haben, prüfen Sie die folgenden Punkte:

1. Die bei OVHcloud angegebene E-Mail-Adresse des Domaininhabers ist gültig und funktioniert.
2. Die Validierungs-E-Mail befindet sich nicht im Spam-Ordner.

Nachdem Sie die beiden oben genannten Punkte überprüft und bestätigt haben, und Sie immer noch nicht in der Lage sind, die Validierungs-E-Mail zu finden, empfehlen wir Ihnen, ein Support-Ticket über das [Hilfezentrum](https://help.ovhcloud.com/csm?id=csm_get_help) zu öffnen, um die erneute Zusendung dieser E-Mail anzufordern.
...
Bei OVHcloud ist es durchaus möglich, IDNs zu bestellen und sie wie reguläre Domainnamen mit unseren anderen Diensten (Webhosting, DNS-Zone usw.<sup>1</sup>) zu nutzen.

Nach der Bestellung erscheinen IDNs in Ihrem [OVHcloud Kundencenter](/links/manager) im Format **xn--**.

Selbst wenn Ihr Domainname in Ihrem [OVHcloud Kundencenter](/links/manager) im [internationalisierten Format (IDN)](https://de.wikipedia.org/wiki/Internationalisierter_Domainname) angezeigt wird, funktioniert und wird er an anderen Stellen völlig normal angezeigt. Die Adresse Ihres Webauftritts wird so angezeigt, wie Sie sie angefordert haben. Ihre E-Mail-Adressen werden ebenfalls so angezeigt, wie Sie es wünschen.

> [!alert]
>
> <sup>1</sup> : Es wird nicht empfohlen, eine E-Mail-Adresse mit einem IDN-Domainnamen über einen E-Mail-Client (Outlook, macOS-Mail usw.) zu verwenden. Tatsächlich interpretieren einige E-Mail-Clients noch nicht die Domainnamen mit Akzentzeichen, was die Übertragung der E-Mails blockiert. Wenn ein Absender Ihnen eine E-Mail sendet, erhält er eine automatische Nachricht, die besagt, dass Ihre E-Mail-Adresse nicht existiert.
>
> **Wir empfehlen dringend, zusätzlich zu Ihrem Domainnamen mit Akzentzeichen den gleichen Domainnamen ohne diese Akzente zu reservieren, um bei der Kommunikation per E-Mail keine Kompatibilitätsprobleme zu haben.**
...
Dazu müssen Sie mindestens als [Kontakt « Rechnung »](/pages/account_and_service_management/account_information/managing_contacts) des betreffenden Domainnamens angegeben sein. Anschließend müssen Sie den Erneuerungsmodus des Domainnamens auf **automatische Verlängerung** ändern.
...
>
> Bei Unsicherheiten empfehlen wir Ihnen, ein Support-Ticket über das [Hilfezentrum](https://help.ovhcloud.com/csm?id=csm_get_help) zu öffnen und den betreffenden Domainnamen sowie das Webhosting dort anzugeben.

> [!success]  
>
> Alle Details finden Sie in unserem Leitfaden "[Wie verlängere ich meine OVHcloud Dienste?](/pages/account_and_service_management/managing_billing_payments_and_services/how_to_use_automatic_renewal)".

///

## Übertragung eines Domainnamens

/// details | Ist mein Domainname nach einem Eigentümerwechsel übertragbar?

Die **I**nternet **C**orporation for **A**ssigned **N**ames and **N**umbers (**ICANN**) hat Sicherheitsmaßnahmen eingeführt, um unbefugte oder missbräuchliche Übertragungen oder Eigentümerwechsel von Domainnamen zu verhindern.

Die ICANN hat insbesondere eine **unveränderliche Frist von 60 Tagen** zwischen jeder Operation festgelegt, die auf einem Domainnamen durchgeführt werden kann (Erstellung, Eigentümerwechsel, Übertragung).

Die von der ICANN festgelegten Regeln müssen von den Registraren (z. B. OVHcloud) strikt eingehalten werden.

Sie haben daher keine andere Wahl, als bis zum Ende der 60-Tage-Frist zu warten, um Ihren Domainnamen nach einem Eigentümerwechsel zu übertragen.

///

/// details | Mein Domainname ist 60 Tage gegen Übertragungen gesperrt, was soll ich tun?
...
Sie haben daher keine andere Wahl, als bis zum Ende der 60-Tage-Frist zu warten, um eine neue Operation (Eigentümerwechsel oder Übertragung) auf Ihrem Domainnamen durchzuführen.

///

/// details | Ich finde meinen Domainnamen in meinem Kundenkonto nicht, was soll ich tun?
...
> [!primary]
>
> Die Änderung einer DNS-Zone ist eine sensible Manipulation und kann zu einer Unterbrechung der Dienste führen, die mit Ihrem Domainnamen verknüpft sind (Webhosting, E-Mail usw.). Falls Sie unsicher sind, zögern Sie nicht, einen [spezialisierten Anbieter](/links/partner) zu kontaktieren.
...
Eine DNS-Zone wird auf **DNS-Servern** gehostet/gespeichert. Diese **DNS-Server** müssen beim Registrar des Domainnamens angegeben werden, um die von ihnen gehostete DNS-Zone nutzen zu können.

> [!success]
>
> Alle Details finden Sie in unserem Leitfaden "[Alle Informationen zu DNS-Zonen](/pages/web_cloud/domains/dns_zone_general_information)".
...
> [!primary]
>
> Die Ausbreitung der Änderung der für einen Domainnamen deklarierten DNS-Server kann bis zu **48** Stunden dauern.

Falls ein Fehler auftritt, empfehlen wir Ihnen, ein Support-Ticket über das [Hilfezentrum](https://help.ovhcloud.com/csm?id=csm_get_help) zu öffnen und folgende Informationen anzugeben:
...
- **Eintrag A** (auch „Hosteintrag“ genannt): Verknüpft einen Domainnamen mit einer IPv4-Adresse (z. B. 213.0.113.0). IPv4-Adressen sind 32-Bit-Adressen, normalerweise in Dezimalnotation mit Punkten geschrieben.
- **Eintrag AAAA** (auch „vierfacher A-Eintrag“ genannt): Verknüpft einen Domainnamen mit einer IPv6-Adresse (z. B. 2001:db8:1:1b00:213:0:113:0). IPv6-Adressen sind 128-Bit-Adressen, normalerweise in Hexadezimalnotation geschrieben.
...
Zu beachten ist, dass ein Domainname sowohl A- als auch AAAA-Einträge haben kann, was es ermöglicht, über IPv4- und IPv6-Netzwerke zugänglich zu sein. Dies wird als „dualer Stapel“ bezeichnet, eine gängige Praxis für Websites und Dienste, die Benutzern auf IPv4- und IPv6-Netzwerken zugänglich sein sollen.
...
/// details | Wie konfiguriere ich einen Eintrag PTR für meine externe IP-Adresse bei OVHcloud?

Bei OVHcloud können Konfigurationen von **P**oin**T**er **R**ecord (**PTR**) nicht direkt in unseren DNS-Zonen verwaltet werden.

Um einen Reverse/PTR-Eintrag für eine externe IP-Adresse zu konfigurieren, wenden Sie sich an Ihren **I**nternetzugangsanbieter (**ISP**), da dieser für die Verwaltung der Reverse-DNS-Einträge der von ihm zugewiesenen IP-Adressen verantwortlich ist.

> [!success]
>
> Alle Details finden Sie in unserem Leitfaden "[Alle Informationen zu DNS-Einträgen](/pages/web_cloud/domains/dns_zone_records)".
...
> [!primary]
>
> Die Ausbreitung der Änderung einer DNS-Zone kann bis zu **24** Stunden dauern.
...
- **Ein Online-Überprüfungstool**: Es gibt mehrere Online-Tools, die die Konfiguration Ihrer DNS-Zone überprüfen können. Sie können sie direkt über einen Webbrowser (Chrome, Edge, Firefox, Safari usw.) aufrufen, indem Sie die entsprechenden Schlüsselwörter (z. B. „DNS-Propagation prüfen“) in eine Suchmaschine eingeben.
...
> [!success]
>
> Alle Details finden Sie in unserem Leitfaden "[Bearbeiten der OVHcloud DNS-Zone](/pages/web_cloud/domains/dns_zone_edit)".

///

/// details | Wie kann ich die Ausbreitung der Änderungen in meiner DNS-Zone überprüfen?

> [!primary]
>
> Vorab wissen Sie:
>
> - Die Ausbreitung einer Änderung in einer DNS-Zone kann bis zu **24** Stunden dauern.
> - Die Ausbreitung einer Änderung der DNS-Server für einen Domainnamen kann bis zu **48** Stunden dauern.

Sie können jedoch die korrekte Ausbreitung der DNS-Änderungen mithilfe des DNS-Eintrags vom Typ **S**tart **O**f **A**uthority (**SOA**) überprüfen.
...
>
> Außerdem gibt es auch Online-Tools, die zur Überprüfung der DNS-Ausbreitung verwendet werden können.
...
- `RR`: Die Anzahl der Aktualisierungen, die am angegebenen Tag durchgeführt wurden. Wenn beispielsweise nur eine Aktualisierung am Tag durchgeführt wurde, hat sie den Wert `00`. Wenn 2 Aktualisierungen am gleichen Tag durchgeführt wurden, hat sie den Wert `01` usw.
...
4. In dem sich öffnenden Fenster identifizieren Sie die zweite Zeile, die in unserem Beispiel wie folgt aussehen würde: `@	IN SOA dns200.anycast.me. tech.ovh.net. (2025091801 86400 3600 3600000 60)`.
...
Dies bedeutet, dass die DNS-Ausbreitung ordnungsgemäß erfolgt. Sie müssen nichts weiter tun.

**Fall 2** – Die beiden Seriennummern sind unterschiedlich:

Dies bedeutet entweder:

- Die DNS-Ausbreitung Ihrer Änderungen ist noch nicht vollständig abgeschlossen (Sie befinden sich noch im Standardzeitraum der DNS-Ausbreitung). In diesem Fall warten Sie, bis die DNS-Ausbreitung vollständig abgeschlossen ist (**24** Stunden für eine Änderung der DNS-Zone und **48** Stunden für eine Änderung der DNS-Server), und wiederholen Sie dann den Vorgang.
- Die DNS-Ausbreitung erfolgt nicht ordnungsgemäß. In diesem Fall klicken Sie direkt im Fenster `Im Textmodus bearbeiten`{.action}, das sich im Schritt **4** geöffnet hat, ohne Änderungen vorzunehmen, auf die Schaltfläche `Weiter`{.action} und dann auf `Bestätigen`{.action}. Eine neue DNS-Ausbreitung wird dann initiiert.
...
> [!success]
>
> Alle Details finden Sie in unserem Leitfaden "[Den Versionsverlauf einer DNS-Zone verwalten](/pages/web_cloud/domains/dns_zone_history)".
...
/// details | Kann ich eine DNS-Zone für einen Unterdomain erstellen?

Sie können eine DNS-Zone für einen Unterdomain erstellen.
...
3. Auf der angezeigten Seite geben Sie den Unterdomain (z. B. *www.domain.tld*) ein, für den Sie eine OVHcloud-DNS-Zone erstellen möchten. Warten Sie einige Sekunden, während das Tool den Unterdomain überprüft.
...
Diese DNS-Zone wird auf 2 OVHcloud-DNS-Servern installiert. Sie müssen die Namen dieser beiden Server in der aktiven DNS-Zone des Domainnamens deklarieren, unter dem Ihr Unterdomain liegt (z. B. *www.domain.tld* ist ein Unterdomain des Domainnamens *domain.tld*).
...
Sobald Sie die beiden DNS-Server in Ihrem Besitz haben, deklarieren Sie sie mithilfe von zwei Einträgen vom Typ NS in der aktiven DNS-Zone des Domainnamens, aus dem Ihr Unterdomain stammt.

**Fall 1** – Die aktive DNS-Zone des Domainnamens, aus dem Ihr Unterdomain stammt, ist bei OVHcloud:
...
4. In dem sich öffnenden Fenster geben Sie den betreffenden Unterdomain in das Feld `Subdomain *`{.action} ein (z. B. geben Sie **ausschließlich** *www* ein, wenn Ihr Domainname *domain.tld* ist und Ihr vollständiger Unterdomain *www.domain.tld* ist). Geben Sie **nur einen** der beiden DNS-Server in das Feld `Ziel *`{.action} ein.
...
**Fall 2** – Die aktive DNS-Zone des Domainnamens, aus dem Ihr Unterdomain stammt, ist nicht bei OVHcloud:

Sie müssen die beiden DNS-Server für Ihren Unterdomain direkt beim DNS-Anbieter Ihres Domainnamens (aus dem Ihr Unterdomain stammt) deklarieren.

> [!primary]
>
> In beiden Fällen kann die Ausbreitung der Änderung einer DNS-Zone bis zu **24** Stunden dauern.
...
/// details | Wie kann ich alle Unterdomains eines Domainnamens auf dieselbe IP-Adresse weiterleiten?
...
4. In dem sich öffnenden Fenster füllen Sie im Feld `Subdomain *`{.action} den Wert `*` aus. Das Asteriskzeichen `*` steht für alle Unterdomains (z. B. `www.domain.tld` oder `ovhcloud.domain.tld`) Ihres Domainnamens. Füllen Sie das Feld `Ziel *`{.action} mit der gewünschten IP-Adresse aus.
5. Klicken Sie auf `Weiter`{.action}, dann auf `Bestätigen`{.action}.
...
/// details | Kann ich in meiner DNS-Zone einen Wildcard einrichten?
...
4. In dem sich öffnenden Fenster füllen Sie im Feld `Subdomain *`{.action} den Wert `*` aus. Das Asteriskzeichen `*` steht für alle Unterdomains (z. B. `www.domain.tld` oder `ovhcloud.domain.tld`) Ihres Domainnamens. Füllen Sie die anderen Felder mit den gewünschten Werten aus.
5. Klicken Sie auf `Weiter`{.action}, dann auf `Bestätigen`{.action}.
...
Bei jeder Löschanfrage eines Dienstes wird eine E-Mail an die E-Mail-Adresse gesendet, die mit Ihrem OVHcloud-Kundenkonto verknüpft ist, um die Löschung zu bestätigen.

Wenn Sie auf den Bestätigungslink in dieser E-Mail nicht geklickt haben, brauchen Sie sich keine Sorgen machen – Ihre DNS-Zone wird nicht gelöscht.

Im Gegenteil, sobald die Löschung initiiert wurde, kann sie nicht mehr storniert werden. Die Löschungsvorgang kann bis zu 3 Tage dauern, bevor Sie eine neue OVHcloud-DNS-Zone für Ihren Domainnamen erstellen können.
...
Dies bedeutet, dass die DNS-Zone des Domainnamens von einem anderen OVHcloud-Kundenkonto verwaltet wird.

Gemäß der **Datenschutz-Grundverordnung (DSGVO)** bleibt das Kundenkonto, auf dem sich die DNS-Zone befindet, vertraulich.

In dieser Situation und wenn Sie dieses andere Kundenkonto nicht kennen, empfehlen wir Ihnen, ein Support-Ticket über das [Hilfezentrum](https://help.ovhcloud.com/csm?id=csm_get_help) zu öffnen, um die Verwaltung der DNS-Zone zu übernehmen.
...
> [!success]
>
> Weitere Einzelheiten finden Sie in unserem Leitfaden „[DNS-Server von Domainnamen individualisieren (Glue Records)](/pages/web_cloud/domains/glue_registry)“.
...
> [!primary]
>
> Die Änderung der DNS-Server ist eine sensible Aktion und kann zu Unterbrechungen der Dienste führen, die mit Ihrem Domainnamen verbunden sind (Webhosting, E-Mail usw.). Falls Sie unsicher sind, zögern Sie nicht, einen [spezialisierten Anbieter](/links/partner) zu kontaktieren.
...
4. Um die DNS-Server zu ändern, klicken Sie auf den Button `DNS-Server ändern`{.action} rechts neben der Tabelle „serveurs DNS“. Abhängig von der Auflösung Ihres Bildschirms kann sich der Button unterhalb der Tabelle befinden.

Sie können die DNS-Server für Ihren Domainnamen auf der angezeigten Seite ändern.

> [!primary]
>
> Die Ausbreitung der Änderung der angegebenen DNS-Server für einen Domainnamen kann bis zu **48** Stunden dauern.

> [!success]
>
> Weitere Einzelheiten finden Sie in unserem Leitfaden „[DNS-Server eines OVHcloud Domainnamens ändern](/pages/web_cloud/domains/dns_server_edit)“.
...
Überprüfen Sie jedoch, ob die im Fehler angezeigten DNS-Server tatsächlich die sind, die Sie für Ihren Domainnamen anwenden möchten. Überprüfen Sie anschließend die Konfiguration der DNS-Zone, die auf diesen DNS-Servern bei Ihrem DNS-Anbieter deklariert ist.
...
> [!success]
>
> Weitere Einzelheiten finden Sie in den folgenden Leitfäden:
>
> - [Bearbeiten der OVHcloud DNS-Zone](/pages/web_cloud/domains/dns_zone_edit)
