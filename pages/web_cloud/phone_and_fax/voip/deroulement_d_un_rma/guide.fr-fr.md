...
excerpt: "Découvrez les étapes de restitution d’un téléphone ou d'une box Internet fournie par OVHcloud"
updated: 2025-10-30
---
...
De même, lors d'un changement de box Internet suite à une migration vers la Fibre OVHcloud ou lors de la résiliation d'un accès à Internet, un RMA est généré afin de restituer la box fournie par OVHcloud. Lors de la résiliation d'un accès Fibre OVHcloud, un second RMA est généré pour la restitution du boîtier fibre (ONT).<br>

**Découvrez les étapes d'un RMA.**

## Prérequis

- Disposer d'un téléphone VoIP fourni sous caution par OVHcloud, ou d'une box Internet fournie en prêt par OVHcloud.
...
Retrouvez dans ce guide les étapes du déroulement d'un RMA pour la restitution d'un téléphone sous caution ou d'une box Internet fournie par OVHcloud.

> [!tabs]
> Restitution de téléphone(s)
>>
>> Cette section décrit 2 exemples de RMA (échange de téléphone et résiliation) afin d'en comprendre le fonctionnement.
...
>> > 
>> > <sup>1</sup>Cette demande de retour sera automatiquement annulée en cas de régularisation de votre situation dans les délais. 
...
>> 
> Restitution d'une box Internet
>>
>> Cette section décrit 2 exemples de RMA (échange de box Internet et résiliation) afin d'en comprendre le fonctionnement.
>> D'autres typologies de RMA existent, leur déroulement étant similaire (envoi d'un e-mail puis rappel et enfin clôture du RMA).
>>
>>
>> **Réception du premier e-mail et envoi du colis**
>>
>> /// details |  E-mail pour un échange d'une box Internet
>> 
>> > 
>> > Objet: [OVH-TELECOM] Bon de retour pour votre matériel : #MODEL# #IDENT# 
>> >
...
>> ///
>> 
>> /// details | E-mail pour une résiliation d'un accès à Internet
>> 
>> > 
>> > Objet: [OVH-TELECOM] Bon de retour pour votre matériel : #MODEL# #IDENT# 
>> >
...
>> >
>> > 1. Connectez-vous à votre [espace client OVHcloud](/links/manager) et cliquez sur `Télécom`{.action}.
>> > 1. Cliquez sur votre nom en haut à droite, puis sur `Mon Compte`{.action}.
>> > 1. Cliquez sur l'onglet `Emails reçus`{.action}.
>> > 1. 
>> >
>> > Les informations relatives au RMA sont alors visibles, ainsi qu'un bouton pour `Télécharger le bon de retour`{.action}.
>> >
