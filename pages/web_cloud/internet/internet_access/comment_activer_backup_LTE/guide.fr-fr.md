...
Un lien de secours LTE permet de sécuriser votre connexion en cas de coupure. Si votre connexion cuivre ou fibre dysfonctionne, une clé LTE branchée au dos du modem prend alors le relais en se connectant au réseau 3G ou 4G.
...
Une fois connecté, accédez au menu `Paramètres`. Ensuite, dans le menu `Gestion Du Code PIN`, renseignez le code PIN de votre carte SIM.

![LTE](images/lte-step1-1.png){.thumbnail}

Retournez sur l'onglet `Accueil` pour vérifier que vous êtes bien connecté. Si la clé est correctement connectée, la LED sur celle-ci doit également être fixe : de couleur cyan pour un réseau 4G ou verte pour un réseau 3G.
...
> [!warning]
>
> En cas de perte de connexion, la VoIP reste fonctionnelle lorsque le modem bascule sur le lien de secours LTE. Cependant, un redémarrage du modem est nécessaire pour que la VoIP soit de nouveau fonctionnelle suite au rétablissement du lien cuivre ou fibre.
>
...
> [!warning]
>
> En cas de perte de connexion, la VoIP sur le modem n'est plus fonctionnelle lorsque le modem bascule sur le lien de secours LTE. Elle redevient automatiquement fonctionnelle suite au rétablissement du lien cuivre.
>
