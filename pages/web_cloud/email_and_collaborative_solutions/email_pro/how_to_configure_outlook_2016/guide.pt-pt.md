...
- Ter a aplicação [Outlook clássico](https://support.microsoft.com/fr-fr/office/installer-ou-r%C3%A9installer-outlook-classique-sur-un-pc-windows-5c94902b-31a5-4274-abb0-b07f4661edf5) no Windows.
...
> [!warning]
>
> Esta documentação aplica-se apenas ao **Outlook clássico** disponível na suite Microsoft 365. Se estiver a utilizar o novo Outlook, consulte o nosso guia [E-mail Pro - Adicionar uma conta de e-mail no novo Outlook para Windows](/pages/web_cloud/email_and_collaborative_solutions/email_pro/how_to_configure_windows_10)
>
...
> 1. O nome do servidor está visível no quadro **Conexão** do separador `Informações Gerais`{.action}.
...
Para configurar a sua morada de e-mail, siga as etapas clicando nos separadores abaixo.
...
>> **Morada de correio** : introduza a sua morada de e-mail completa.<br>
>>
...
>> **Nome de utilizador** : Introduza a sua morada de e-mail completa.<br>
>> **Palavra-passe** : Introduza a palavra-passe associada à sua morada de e-mail.<br>
>>
...
> **Configuração IMAP**
>>
>> - **Nome de utilizador** : preencha a morada de e-mail **completa**.
>> - **Palavra-passe** : preencha a palavra-passe da morada de e-mail.
...
Fale com nossa [comunidade de utilizadores](/links/community).déplacer le fichier c