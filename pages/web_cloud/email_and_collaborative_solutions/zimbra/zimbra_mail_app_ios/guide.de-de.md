...
>> 2. Tippen Sie auf `Account hinzufügen`{.action}.
>> 3. Wählen Sie `Microsoft Exchange`{.action} aus.
>>
>> ![iOS Mail](images/mail-app-ios-add-step-01.png){.thumbnail .h-500}
>>
> **Schritt 2**
>>
>> 1. Geben Sie Ihre E-Mail-Adresse und eine Beschreibung ein und drücken Sie `Weiter`{.action}.
>> 2. Wählen Sie im angezeigten Fenster `Manuell konfigurieren`{.action}.
>>
>> ![iOS Mail](images/mail-app-ios-add-step-02.png){.thumbnail .h-500}
>>
> **Schritt 3**
>>
...
>>
>> ![iOS Mail](images/mail-app-ios-add-step-03.png){.thumbnail .h-500}
>>
> **Schritt 4**
>>
...
1. Tippen Sie unten auf der Seite auf `Kontoeinstellungen`{.action}.
...
![iOS Mail](images/mail-app-ios-modify-delete-01.png){.thumbnail .h-500}
