...
>> - **Descripción**: Introduzca un nombre que le permita identificar su cuenta entre las demás cuentas de correo electrónico registradas en su cuenta de correo.
>>
>> Para completar la configuración, pulsa `Siguiente`{.action} y selecciona las características que deseas explorar en tu iPhone o iPad.
>>
...
1. Pulsa `Ajustes de la cuenta`{.action} en la parte inferior de la página.
