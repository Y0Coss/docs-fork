...
- Pour une offre **MXplan**, dirigez-vous dans la section `Web Cloud`{.action}, cliquez sur `MX Plan`{.action}, puis sélectionnez le nom de domaine concerné. Cliquez sur l'onglet `Comptes e-mail`{.action}. Vérifiez l'état du compte e-mail concerné dans la colonne `Statut`.
