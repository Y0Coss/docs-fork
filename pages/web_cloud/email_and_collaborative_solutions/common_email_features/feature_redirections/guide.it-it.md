...
> **3. Alias email**
>>
>> L'email è indirizzata all'alias che lo rinvia al destinatario sul quale l'alias è stato configurato. La voce `Received by` indica l’indirizzo email che riceve l’email.
>>
...
>>
>> Di default, ti trovi nella scheda `Informazioni generali`{.action} del tuo MX Plan. Clicca sulla scheda `Email`{.action} e poi sul pulsante `Gestione dei reindirizzamenti`{.action} a destra.
>>
...
>> - **Verso l'indirizzo**: inserisci qui l'indirizzo di destinazione del tuo reindirizzamento. Può trattarsi di uno dei tuoi indirizzi email OVHcloud o di un indirizzo email esterno.
...
>>      - **Non conservare una copia dell'email**: reindirizzare direttamente verso l'indirizzo di reindirizzamento senza che l'indirizzo principale lo riceva (vedi lo [schema 1](#diagram) all'inizio di questa guida).
>>
...
> **Step 1**
>>
>> Una volta connesso al tuo indirizzo email tramite la [webmail](/links/web/email), clicca sull’icona a forma di ingranaggio in alto a destra e poi su `Options`{.action}.
>>
...
>>
>> ![email](images/email-all-02.png){.thumbnail .w-640}
>>
...
>>
>> ![email](images/email-all-03.png){.thumbnail .w-640}
>>
> **Step 4**
>>
...
>>
>> ![email](images/email-all-04.png){.thumbnail .w-640}
>>
> **Step 5**
>>
...
>>
>> ![email](images/email-all-05.png){.thumbnail .w-640}
>>
> **Step 6**
>>
...
>>
>> ![email](images/email-all-06.png){.thumbnail .w-640}
>>
...
>
> ![email](immagini/email-all-07.png){.thumbnail .w-640}
>
...
> Il presente capitolo si riferisce alle seguenti offerte:
>
> - **MX Plan** con la voce zimbra per la webmail.
> - **Zimbra.**
>
...
> **Step 1**
>>
>> Una volta connesso all’interfaccia della Webmail OWA, clicca sull’icona a forma di ingranaggio in alto a destra e poi su `Options`{.action}.
>>
>> ![email](images/email-all-01.png){.thumbnail .w-640}
>>
> **Step 2**
