...
Once this information has been entered, you can save these changes for MX Plan solutions by clicking on `Next`{.action}, then `Confirm`{.action}. For the Exchange solution, click `Save changes`{.action}.
...
Once this information has been entered, you can save these changes for Email solutions by clicking on `Next`{.action}, then `Confirm`{.action}. For the Exchange solution, click `Save changes`{.action}.
