...
/// details | Zimbra, qu'est-ce que c'est ?
...
- **Zimbra** : Zimbra fait son apparition dans le catalogue OVHcloud en tant qu'offre à part entière avec l'offre [Zimbra Starter](/links/web/zimbra).
...
/// details | Quelles sont les différences entre les webmail Outlook Web Acces (OWA) et Zimbra ?
...
/// details | La migration ouvre-t-elle de nouvelles fonctionnalités ?

La migration vers le nouveau webmail maintient le même niveau de services que le précédent.

///

/// details | Quand aura lieu la migration de mes services ?
...
/// details | Comment préparer ma migration vers Zimbra?
...
/// details | Ai-je des manipulations à effectuer dans le cadre de la migration vers Zimbra?
...
/// details | Des changements sont-ils à prévoir dans l'espace client OVHcloud ?
...
/// details | Vais-je devoir reconfigurer mon logiciel de messagerie ?
...
/// details | La migration change-t-elle la facturation de mon service ?
...
/// details | Où seront hébergés mes e-mails après la migration ?

La migration se fait au sein de nos datacentres français. Vos données restent en France.

///

/// details | Y aura-t-il des changements concernant le traitement de mes données ?
...
/// details | Puis je m'opposer à la migration ?
...
/// details | Les fonctionnalités maintenues , suspendues ou retirées lors de la migration vers Zimbra. <a name="features"></a> 
...
|**Contacts externes**|Cette fonctionnalité permet d'intégrer une adresse e-mail externe à la plateforme e-mail dans son carnet d'adresse global. Cette fonction ne sera pas présente sur Zimbra.|❌|
