...
Once you have created your email addresses, you can start using them. There are two ways of doing this: using webmail from an internet browser, or using an email client.
...
> **Roundcube**
>>
>> You should see an interface similar to the image below with the word “Rouncube” in the top left.
...
If you just want the information you need to configure your email address, you can find the settings below.
...
- **US/ASIA-PACIFIC (outgoing) server**: pop.mail.ovh.ca.
- **Port**: 465.
- **Security type**: SSL/TLS.
...
When you need to leave, it is important to be able to set up an automatic response to indicate that you cannot view or process your emails.
...
> **Zimbra**
>>
>> You can set up an automatic reply directly by logging in to your email address via Webmail. For further details, please refer to our guide on [Using Zimbra webmail](/pages/web_cloud/email_and_collaborative_solutions/mx_plan/email_zimbra) , and go to our summary page to select “Automatic replies/Voicemail”.
>>
> **OWA**
>>
>> You can set up an automatic reply directly by logging in to your email address via Webmail. For further details, please refer to our guide on [Using an email address via the Outlook Web App (OWA)](/pages/web_cloud/email_and_collaborative_solutions/using_the_outlook_web_app_webmail/email_owa) , and go directly to the chapter on Adding automatic replies .
>>
