...
>> 2. Puede contratar una cuenta Zimbra desde el [área de cliente de OVHcloud](/links/manager) o directamente en [ovhcloud.com](/links/web/email).
...
>> 2. Puede contratar una cuenta Email Pro desde el [área de cliente de OVHcloud](/links/manager) o directamente en [ovhcloud.com](/links/web/email).
...
/// details | ¿Cómo identificar la tecnología utilizada en mi solución **MX Plan**?
...
1. Acceda a la sección de la columna `Web Cloud`{.action}.
1. Haga clic en `MX Plan`{.action}.
1. Seleccione el dominio.
1. En la pestaña `Información general`{.action}, seleccione por defecto.
...
> [!tabs]
> **Correo electrónico y Zimbra Mail**
>>
>> **Equipo Windows**
...
>> - [Correo de Windows](/pages/web_cloud/email_and_collaborative_solutions/email_pro/how_to_configure_windows_10).
>>
>> **Ordenador Apple Mac**
