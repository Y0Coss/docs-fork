...
>> 3. This offer is available in 3 different email technologies. **Roundcube**, **OWA** (Outlook Web Access) and **Zimbra**.
>>
> **Zimbra Mail**
>>
...
>> 2. You can order a Zimbra account via the [OVHcloud Control Panel](/links/manager) or directly on [ovhcloud.com](/links/web/email).
...
/// details | What are the differences between the email technologies used by the **MX Plan** solutions?
