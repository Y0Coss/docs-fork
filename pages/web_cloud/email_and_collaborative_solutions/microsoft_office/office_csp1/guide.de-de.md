...
Sobald die Lizenz aktiviert ist, erhalten Sie eine E-Mail an die Kontakt-E-Mail-Adresse Ihres OVHcloud Kunden-Accounts. Sie finden diese E-Mail auch in Ihrem [OVHcloud Kundencenter](/links/manager), indem Sie in Ihrem Profil oben rechts auf `Meine Kommunikation`{.action} im Bereich `Empfangene E-Mails` klicken.
...
Gehen Sie auf <https://portal.office.com/> und melden Sie sich mit der zuvor erhaltenen **E-Mail-Adresse** und dem **Passwort** an. Sie werden zu einem Fenster weitergeleitet, in dem Sie die Microsoft 365 Suite auf Ihren Computer herunterladen können, mit Installationsanweisungen.
