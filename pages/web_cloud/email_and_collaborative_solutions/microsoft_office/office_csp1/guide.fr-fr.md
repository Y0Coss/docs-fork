...
Il y a plusieurs avantages à souscrire aux offres OVHcloud **Microsoft 365 apps for business** ou **Microsoft 365 apps for enterprise**. La facturation est mensuelle et vous pouvez installer une licence sur 5 PC/Mac, 5 tablettes et 5 smartphones.
...
- Licences Apps for enterprise : Excel, Word, PowerPoint, Outlook, Note, Publisher, Access.
...
- Rendez-vous sur la page commerciale [Microsoft 365 OVHcloud](/links/web/ms365) ou depuis l'[espace client OVHcloud](/links/manager):
    1. Rendez-vous dans la partie `Web Cloud`{.action}.
    1. Dans la rubrique `MICROSOFT`, cliquez sur `Microsoft 365`{.action}.
    1. Cliquez sur `Commander`{.action}
- Choisissez parmi nos offres disponibles, à savoir « Apps for business » et « Apps for enterprise ».
- Définissez la fréquence de renouvellement de votre groupe de licence.
- Définissez le nombre de licences que vous souhaitez, puis finalisez votre commande.

### Activer votre licence

Pour activer la licence que vous avez commandée :
...
Saisissez les informations relatives à l'utilisateur de la licence, puis cliquez sur `Valider`{.action}
...
Depuis l'onglet `Licences`{.action} de votre groupe de licences, cliquez sur le bouton &#8942; à droite de la licence à résilier, puis cliquez sur `Supprimer le compte`{.action}.
...
1. Cliquez sur le bouton `...`{.action} à droite du groupe de licences à résilier, puis sur `Résilier`{.action}.
