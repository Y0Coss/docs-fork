...
La solution [Web Cloud Databases](/links/web/databases) peut contenir plusieurs bases de données. Elle permet donc de définir un ou plusieurs utilisateurs pour gérer et utiliser ses bases de données. Ces utilisateurs peuvent avoir des droits plus ou moins élevés en fonction de leurs rôles au niveau de vos bases de données. Au cours de l'utilisation du produit, vous pouvez être amenés à modifier les droits d'un utilisateur sur votre [Web Cloud Databases](/links/web/databases).
...
<th><center>Lecture / Ecriture</center></th>
