...
To allow GitLab CI/CD to automatically deploy your website, configure secure SSH access to your VPS.
...
Refer to [official GitLab documentation](https://docs.gitlab.com/ee/user/ssh.html){.external} for more details on generating an SSH key pair.
...
### Add private key to GitLab <a name="add-private-key-gitlab"></a>
...
3\. Add the file to the Git trace, commit it, and then push the changes to the remote repository:
