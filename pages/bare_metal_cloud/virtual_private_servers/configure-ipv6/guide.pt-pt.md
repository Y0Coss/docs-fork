...
- [Aplicação persistente em Redhat e derivados (CentOS, Rocky Linux, AlmaLinux, etc.)](#persistentredhat).
...
/// details | **Etapa 4: Desativar a gestão da rede Cloud-init (como opção)**
