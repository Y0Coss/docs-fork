...
Além do direcionamento IP privado, o [vRack](/links/network/vrack){.external} permite direcionar o tráfego IP público através da porta vRack do servidor através de um bloco de endereços IP públicos.
