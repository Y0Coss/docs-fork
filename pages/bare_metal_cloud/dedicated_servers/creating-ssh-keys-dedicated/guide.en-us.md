...
> [!primary]
>
> `Ed25519` is considered the most secure method but `RSA` is a valid alternative. Both are compatible with the OVHcloud Control Panel if you want to [store public keys in your customer account](/pages/bare_metal_cloud/dedicated_servers/import-keys-control-panel).
...
Copy this key string to [add it to a new server](#getstarted) or to [import it into the OVHcloud Control Panel](/pages/bare_metal_cloud/dedicated_servers/import-keys-control-panel).
