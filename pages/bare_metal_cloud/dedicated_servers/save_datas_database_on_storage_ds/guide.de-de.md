...
- empfohlen: ein privates Netzwerk zwischen Ihren Servern ([OVHcloud vRack](/links/network/vrack){.external})
...
![Konfiguration der Partitionen anpassen](images/custompartition.png){.thumbnail}
