...
To export logs from your archives, we provide a tool to download them: [ldp-archive-mirror](https://github.com/ovh/ldp-archive-mirror){.external} This software requires Python ≥ 3.6 to run.
...
Please go to the [github page](https://github.com/ovh/ldp-archive-mirror){.external} to setup this software and obtain the latest information on it.
...
Documentation for elasticdump is available at: <https://github.com/elasticsearch-dump/elasticsearch-dump>.
