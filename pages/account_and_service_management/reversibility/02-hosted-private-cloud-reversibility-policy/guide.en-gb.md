...
| Dedicated storage (vSAN and/or NFS) | Use of dedicated vSAN and/or NFS datastores, snapshot and clone management. | .stream.vmdk | **Inbound** : Add datastores, restore VMs and snapshots <br>**Outbound** : export VMs and snapshots to compatible target storage. | [Using VMware Hyperconvergence with vSAN](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_vsan)<br><br>.{external}[Download Files or Folders from vSAN Datastores](https://techdocs.broadcom.com/us/en/vmware-cis/vsan/vsan/8-0/vsan-administration/configuring-and-managing-a-vsan-cluster/download-files-or-folders-from-vsan-datastores.html) |
