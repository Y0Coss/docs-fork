---
title: Politique de réversibilité du produit Dedicated Server 3-AZ
updated: 2025-06-24
---
...
| ACL, firewall et sécurité avancée | Gestion des règles de sécurité, ACL, firewall réseau OVHcloud | Règles firewall, scripts | **Migration entrante** : Reconfiguration manuelle ou avec des scripts des règles.
**Migration sortante** : Export des configurations, adaptation aux outils de sécurité de la cible.| [Rubrique Réseau et IP](/pages/bare_metal_cloud/dedicated_servers) |
...
Les serveurs dédiés sont déployés sur 3 datacenters répartis sur trois zones de disponibilité physiquement indépendantes, distantes de plusieurs kilomètres, avec réseau privé faible latence et alimentation, refroidissement, réseau et sécurité redondés pour chaque datacenter.
