...
excerpt: "Découvrez comment prendre en main et configurer votre On-Prem Cloud Plateform"
updated: 2025-11-13
---

## Objectif

Ce guide a été conçu pour vous présenter comment se connecter aux interfaces graphiques de votre **OPCP** en tant que qu'administrateur de ce service.
...
* À la configuration des utilisateurs au sein de *Keycloak* via le lien IAM sous votre identifiant.
...
Depuis l'espace utilisateur de **OPCP**, l’interface Openstack Horizon est accessible via le lien dans le dashboard. 
...
La Vue Network (réseau) vous permet de visualiser et gérer les réseaux de votre service **OPCP**. Cette interface permet de créer des réseaux mutualisés ou distincts entre vos serveurs dédiées.
...
Cette section contient la liste des réseaux disponibles pour les serveurs dédiées sur votre **OPCP**.
