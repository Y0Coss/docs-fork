...
Cliquez sur le menu à trois points puis sur `Add a subnet`{.action}.
...
- Assurez-vous que le VDC est rattaché au **même vRack** que celui que vous avez lié au bloc d’adresses IP publiques dans le guide précédent [Public VCF as-a-Service Linking a public IP block with vRack](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vcd_link_ip_to_vrack).

## Aller plus loin

Guide de première étape : [Public VCF as-a-Service Linking a public IP block with vRack](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vcd_link_ip_to_vrack).
