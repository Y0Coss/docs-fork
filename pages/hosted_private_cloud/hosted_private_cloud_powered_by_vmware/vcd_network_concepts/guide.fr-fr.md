...
- Avoir suivi le guide « [Public VCF as-a-Service - Les concepts fondamentaux de Public VCF as-a-Service](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vcd-get-concepts) ».

## En pratique

/// details | Introduction de la pratique du réseau dans Public VCF as-a-Service.
...
/// details | Quelles sont les bonnes pratiques dans l'espace client Public VCF as-a-Service ?
...
Vous retrouvez les topologies réseau depuis le control panel Public VCF as-a-Service en cliquant sur : `Mise en réseau | Espace ip  | Mon Nom d'IP space | Configuration | Topologie Réseau`{.action}
