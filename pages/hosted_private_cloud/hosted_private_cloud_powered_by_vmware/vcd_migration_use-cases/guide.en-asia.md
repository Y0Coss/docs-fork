...
**The purpose of this guide is to provide you with the information you need to migrate to a Public VCF as-a-Service on OVHcloud environment.**
...
You can now reset the **Admin** password for a Managed Public VCF as-a-Service organization using APIv2: [Access APIv2](https://ca.api.ovh.com/console/?section=%2FvmwareCloudDirector&branch=v2#post-/vmwareCloudDirector/organization/-organizationId-/password).
