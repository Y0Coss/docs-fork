...
* Having added the private gateway network to [restrictions per source IP](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/manager_ovh_private_cloud).
