...
Ce guide explique comment migrer vos charges de travail VMware on-premises vers un **environnement OVHcloud Hosted Private Cloud (HPC) qualifié SecNumCloud**, en utilisant  **Zerto Virtual Replication**.
