...
- Si vous utilisez NSX-T :
    ...
    - Choisissez vos pare-feux virtuels (Stormshield, FortiVM, Palo Alto VM-Series).
...
- Suivez le [guide dédié](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/autoriser_des_ip_a_se_connecter_au_vcenter/guide.en-gb.md) pour autoriser les IPs de votre infrastructure source et des composants Veeam.
- Pour éviter la double authentification (2FA) sur les composants Veeam, consultez la section *Application access permission* de [ce guide](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/utilisation_2FA/guide.en-gb.md).
...
Pour savoir comment créer des comptes locaux et activer l’authentification à deux facteurs, suivez [cette documentation](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/interface-secure/guide.en-gb.md).
...
Pour débuter avec NSX-T, référez-vous au [guide de prise en main NSX](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/nsx-01-first-steps/guide.en-gb.md).
...
Pour l’installation pas à pas, suivez [ce guide officiel](/pages/storage_and_backup/backup_and_disaster_recovery_solutions/veeam/veeam_veeam_backup_replication/guide.en-gb.md).
...
- [NSX avec IPsec](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/nsx-12-configure-ipsec/guide.en-gb.md)
...
Pour plus de performance et une latence réduite, vous pouvez utiliser [OVHcloud Connect](https://www.ovhcloud.com/en-gb/network/ovhcloud-connect/).

> [!warning]
> Les environnements SNC requièrent des SPN. Pour en savoir plus, consultez [ce guide](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/snc-connectivity-concepts-vpn-spn/guide.en-gb.md).
...
Suivez [ce guide officiel de configuration du proxy Veeam](https://helpcenter.veeam.com/docs/backup/vsphere/add_vmware_proxy.html?ver=120).
...
- Testez l’AD, DNS, antivirus, bases de données, services web et applicatifs critiques
...
Consultez le [guide Storage vMotion](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_storage_vmotion/guide.en-gb.md).

### Étape 17 : Créer des jobs de sauvegarde

Protégez vos VMs à long terme en créant des jobs de sauvegarde Veeam vers le **stockage objet OVHcloud** (compatible S3*).

Suivez les étapes décrites dans [notre guide dédié](/pages/storage_and_backup/object_storage/s3_veeam/guide.en-gb.md).
