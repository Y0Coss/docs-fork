...
[Informações sobre o método de faturação Public Cloud](/pages/public_cloud/public_cloud_cross_functional/analyze_billing)

[Parâmetros de acesso e de segurança no Horizon](/pages/public_cloud/public_cloud_cross_functional/access_and_security_in_horizon)
