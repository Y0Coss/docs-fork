...
Dans le guide [créer un accès à Horizon](/pages/public_cloud/public_cloud_cross_functional/introducing_horizon){.external}, il vous a été expliqué comment créer et supprimer un utilisateur OpenStack et générer un mot de passe d’accès.
