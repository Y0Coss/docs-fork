...
Una vez que haya creado un usuario OpenStack y haya generado una contraseña de acceso siguiendo la guía [Crear un acceso a Horizon](/pages/public_cloud/public_cloud_cross_functional/introducing_horizon){.external}, puede cambiar dicha contraseña desde el panel Horizon. 
