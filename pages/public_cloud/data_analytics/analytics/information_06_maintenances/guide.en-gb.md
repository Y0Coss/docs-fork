...
> [!api]
>
> @api {v1} /cloud GET /1.0/cloud/project/{serviceName}/database/opensearch/{productId}/maintenance
>
...
> [!api]
>
> @api {v1} /cloud POST /1.0/cloud/project/{serviceName}/database/opensearch/{productId}/maintenance/{maintenanceId}/apply
>
