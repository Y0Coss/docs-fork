...
3. An API key generated from the [OVHcloud Manager](https://www.ovh.com/manager), in Public Cloud > AI Endpoints > API keys

![Generate an API key](images/generate_an_api_key.png)
...
![Output of the code](images/output_1.png)
...
![Output of the code](images/output_7.png)
...
![Output of the code](images/output_8.png)
...
![AI Endpoints Catalog](images/output_9.png)
...
- Implement regular key rotation. You can set an expiry date to your key in the OVHCloud manager.
