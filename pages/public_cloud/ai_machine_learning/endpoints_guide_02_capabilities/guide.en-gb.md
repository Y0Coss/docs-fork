...
| JSON Mode (JSON Object)                       | AI Endpoints supports JSON mode, which ensures the model's output is always syntactically valid JSON. Ideal when you want reliably parseable JSON format.                                                                   |
