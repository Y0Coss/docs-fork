...
> [!alert]
>
> Esta guía solo se aplica a las instancias con **facturación por horas**. Si sus instancias tienen una facturación mensual **mensual**, la facturación clásica seguirá aplicándose independientemente del estado del servicio.
>
