...
Otwórz przeglądarkę internetową i zaloguj się do strony WordPress wprowadzając adres IP Twojej instancji (lub nazwę domeny, jeśli już [podłączyłeś ją do instancji](/pages/web_cloud/domains/dns_zone_edit)). Wybierz język na pierwszej stronie.
