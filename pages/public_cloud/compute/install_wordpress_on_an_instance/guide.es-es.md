...
Abra un navegador web y conéctese al sitio WordPress introduciendo la dirección IP de su instancia (o el nombre de dominio si ya ha [asociado uno a la instancia](/pages/web_cloud/domains/dns_zone_edit)). Seleccione un idioma en la primera página.
